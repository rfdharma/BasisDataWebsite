            ...
            @foreach ($items as $item)
                <div class="card-popular" style="margin-top: 75px">
                    <div>
                        ...
                        <a href="{{ route('front.detail', ['id' => $item->id]) }}" class="absolute inset-0"></a>
                    </div>
                    <img src="{{ asset('storage/' . $item->photos[0]['photos']) }}" class="h-[150px] w-full min-w-[216px] rounded-[18px]" alt="">
