<x-app-layout>
    <x-slot name="title">Edit Type Car</x-slot>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            <a href="{{ route('owner.types.index') }}" >
                ←
            </a>
            {!! __('Type &raquo; Sunting &raquo; ') . $type->name !!}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('owner.types.update', $type->id) }}" method="post" enctype="multipart/form-data"
