...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            <?php echo e(__('Vehicle &raquo; Create')); ?>
                ...
                <form class="w-full" action="<?php echo e(route('owner.vehicles.store')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="-mx-3 mt-4 mb-6 grid grid-cols-3 gap-3 px-3">
                        <div class="w-full">
                            ...
                            <input value="<?php echo e(old('star')); ?>" name="star"
                                   class="block w-full appearance-none rounded border border-gray-200 bg-gray-200 px-4 py-3 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none"
                        ...
                        <div class="w-full">
                            ...
                            <input value="<?php echo e(old('review')); ?>" name="review"
                                   class="block w-full appearance-none rounded border border-gray-200 bg-gray-200 px-4 py-3 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Github\rent-car\resources\views/owner/vehicles/create.blade.php ENDPATH**/ ?>