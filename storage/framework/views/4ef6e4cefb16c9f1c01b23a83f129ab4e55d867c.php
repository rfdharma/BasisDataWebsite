                ...
                <div class="absolute z-0 hidden lg:block">
                    <div class="text-[220px] font-extrabold leading-[101%] tracking-[-0.06em] text-darkGrey">
                        ...
                        <div data-aos="fade-left" data-aos-delay="600">
                            <?php echo e($items_landing[count($items_landing) - 1]->brand->name); ?>

                        </div>
                    </div>
                </div>
                <img src="<?php echo e($items_landing[count($items_landing) - 1]->thumbnail); ?>" class="relative z-5 w-full max-w-[963px] rounded-[30px] img-fluid" alt="Car.png" data-aos="zoom-in" data-aos-delay="1150">
            </div>
            ...
            <div class="flex flex-col items-center justify-around gap-7 lg:flex-row lg:gap-[60px]">
                ...
                <div class="flex flex-col items-center gap-[2px] px-3 md:px-10" data-aos="fade-left" data-aos-delay="950">
                    <h6 class="text-center font-bold text-dark md:text-[26px] pb-2" style="font-size: 35px">
                        <?php echo e($items_landing[count($items_landing) - 1]->name); ?>
                ...
                <div class="group rounded-full bg-primary p-1" data-aos="zoom-in" data-aos-delay="1200">
                    <a href="<?php echo e(route('front.checkout', ['slug' => $items[count($items) - 1]->slug, 'thumbnail' => $items_landing[count($items_landing) - 1]->thumbnail])); ?>" class="btn-primary">
                        <p>
                            Rent Now
                        </p>
        ...
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="card-popular">
            <div>
              ...
              <a href="<?php echo e(route('front.detail', $item->slug)); ?>" class="absolute inset-0"></a>
            </div>
            <img src="<?php echo e($item->thumbnail); ?>" class="h-[150px] w-full min-w-[216px] rounded-[18px]" alt="">
