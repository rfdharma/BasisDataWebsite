        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <?php endif; ?>
                ...
                <?php if(session('success')): ?>
                    <div class="bg-green-200 text-green-800 border-t-4 border-green-500 rounded-b px-4 py-3 shadow-md" role="alert">
                        <div class="flex">
                ...
                <?php if(session('error')): ?>
                    <div class="bg-red-200 text-red-800 border-t-4 border-red-500 rounded-b px-4 py-3 shadow-md" role="alert">
                        <div class="flex">
                            <div class="py-1"><svg class="h-6 w-6 text-red-500 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></div>
                            <div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\BasisDataWebsite\resources\views/owner/vehicles/editplate.blade.php ENDPATH**/ ?>