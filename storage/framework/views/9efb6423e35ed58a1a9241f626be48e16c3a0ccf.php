...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Create Brand Car <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            <a href="<?php echo e(route('owner.brands.index')); ?>">
                ←
            </a>
            <?php echo __('Brand &raquo; Create'); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\BasisDataWebsite\resources\views/owner/brands/create.blade.php ENDPATH**/ ?>