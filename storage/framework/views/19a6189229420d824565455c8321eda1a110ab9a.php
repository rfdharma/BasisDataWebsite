...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Create Type Car <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            <a href="<?php echo e(route('owner.types.index')); ?>">
                ←
            </a>
            <?php echo __('Type &raquo; Create'); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\BasisDataWebsite\resources\views/owner/types/create.blade.php ENDPATH**/ ?>